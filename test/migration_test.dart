...
void main() {
  test(
    ...
    () async {
      ...
      final remotePackMetadata = await db
          .select(db.remotePackSyncMetadata)
          .get();
      final remoteItemMetadata = await db
          .select(db.remoteItemSyncMetadata)
          .get();
      ...
      expect(
        packs.firstWhere((pack) => pack.id == packId).packType,
        'personal',
      );
